<div class="schedules index">
	...
	<tr>
		...
		<td><?php echo h($schedule['Schedule']['filename']); ?>&nbsp;</td>
		<td><?php echo h($schedule['Schedule']['dir']); ?>&nbsp;</td>
		<td><?php echo h($schedule['Schedule']['mimetype']); ?>&nbsp;</td>
		<td><?php echo h($schedule['Schedule']['filesize']); ?>&nbsp;</td>
