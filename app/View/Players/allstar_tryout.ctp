...
<h2>All Stars Tryout -- <?php echo $players[0]['League']['name']; ?></h2>
...
<p>
<?php echo $this->Html->link('Add Tryout Number', array('action'=> 'allstar_tryout', 'number', $league_id), null, 'This will reset all of the all star tryout numbers. Continue?'); ?>

<?php echo $this->Html->link('Download PDF', array('action'=> 'allstar_tryout', 'pdf', $league_id)); ?>

<?php echo $this->Html->link('Download Excel', array('action'=> 'allstar_tryout', 'csv', $league_id)); ?>
</p>
<table>
   <tr>
      <th>Actions</th>
